...
ROUTES = {
    ...
    ("GET", "/api/auth/google_login"): auth.google_login,
    ("GET", "/api/auth/google_callback"): auth.google_callback,
    ...
    ("GET", "/api/accounts/placement_log"): accounts.placement_log,
    ...
    ("POST", "/api/sequences/import_contacts"): sequences.import_contacts,
    ...
    ("GET", "/api/cron/placement_check"): cron.placement_check,
    ("POST", "/api/cron/placement_check"): cron.placement_check,
